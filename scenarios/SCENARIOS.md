...
| **oomkill-cronjob**       | bank-of-bedrock          | `memory-intensive-cronjob` (CronJob) fails every minute due to allocating more memory than limit | ✅ Yes       | Manual CronJob deletion or limit increase required |
